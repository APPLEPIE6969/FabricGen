...
const MODELS: RankedModel[] = [
  ...
  { provider: 'nvidia', model: 'meta/llama-3.1-405b-instruct', params: '405B' },
  ...
  { provider: 'openrouter', model: 'nvidia/nemotron-3-nano-30b-a3b:free', params: '30B MoE' },
  ...
  { provider: 'openrouter', model: 'nvidia/nemotron-nano-9b-v2:free', params: '9B' },
